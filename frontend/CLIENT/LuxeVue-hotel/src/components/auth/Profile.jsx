...
import { deleteUser, getBookingsByUserId } from "../utils/ApiFunctions";
...
const Profile = () => {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        // Simulate fetching bookings by user ID from API
        // Replace this with actual API call to fetch bookings
        const response = [
          {
            id: "1",
          ...
          },
          {
            ...
            bookingConfirmationCode: "XYZ789"
          }
        ];
  ...
  const handleDeleteAccount = async () => {
    ...
    if (confirmed) {
      try {
        ...
        // Replace this with actual API call to delete user account
